...
do
 ...
 curl -o ${model}/${vartype}/wget_${model}_${vartype}.sh "http://pcmdi9.llnl.gov/esg-search/wget/?${variables}&model=${model}&project=CMIP5&experiment=historical&cmor_table=Amon&cmor_table=LImon&ensemble=r1i1p1&distrib=true"
